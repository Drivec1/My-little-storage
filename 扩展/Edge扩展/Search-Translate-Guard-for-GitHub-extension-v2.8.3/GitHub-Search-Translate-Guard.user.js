...
(() => {
  ...
  function buildFallback(context) {
    ...
    shadow.addEventListener("keydown", (event) => {
      // GitHub registers bare-character shortcuts such as "s" and "/" on
      // document. Outside this shadow root, event.target is retargeted to the
      // fallback host instead of the input, so GitHub can mistake typing for a
      // page shortcut and cancel the character. Keep fallback keystrokes local
      // while preserving their normal input and form default actions.
